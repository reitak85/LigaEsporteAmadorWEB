...
@Controller("voleiController")
@Scope("request")
public class VoleiController extends VideoBO {
	...
	public void findHomeVideos() {
		try {
			videos = videoService.findVideoVolei();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void findHomeVideoAmador() {
		try {
			videosAmador = videoService.findVideoAmadorVolei();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
