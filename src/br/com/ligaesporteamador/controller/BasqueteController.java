...
@Controller("basqueteController")
@Scope("request")
public class BasqueteController extends VideoBO {
	...
	public void findHomeVideos() {
		try {
			videos = videoService.findVideoBasquete();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void findHomeVideoAmador() {
		try {
			videosAmador = videoService.findVideoAmadorBasquete();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
