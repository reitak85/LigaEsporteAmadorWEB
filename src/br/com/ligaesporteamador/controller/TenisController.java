...
@Controller("tenisController")
@Scope("request")
public class TenisController extends VideoBO {
	...
	public void findHomeVideos() {
		try {
			videos = videoService.findVideoTenis();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void findHomeVideoAmador() {
		try {
			videosAmador = videoService.findVideoAmadorTenis();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
